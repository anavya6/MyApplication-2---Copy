 ...
 */
public class AnalyseGraph extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.analyse_graph);
         ...
         ArrayList<Location> selectedList = bundle.getParcelableArrayList("selectedLocationList");
         for(Location location:selectedList){
             System.out.println(location.getBinNumber());
             System.out.println(location.getGeoLocation());
             System.out.println(location.getFillLevel());
             System.out.println(location.getFillDate());
         }
         locationList=selectedList;
    ...
    private void openChart(){
        ...
        XYSeries binFillTrendSeries1  = new XYSeries("Bin1");
        // Creating an XYSeries for Expense
        XYSeries binFillTrendSeries2  = new XYSeries("Bin2");
        ...
        multiRenderer.setChartTitle(query);
